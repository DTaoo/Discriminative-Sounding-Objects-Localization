...
class BaseDataset(torchdata.Dataset):
    ...
    def _load_frames(self, path):
        ...
        for img in paths:
            ...
            frames.append(self._load_frame(img))
    ...
    def _load_audio_file(self, path, center_timestamp):
        if path.endswith('.mp3'):
            ...
            audio_raw, rate = librosa.load(path, sr=16000, mono=True, offset=center_timestamp, duration=1.03)
    ...
    def _load_audio(self, path, center_timestamp, nearest_resample=False):
        ...
        # load audio
        audio_raw, rate = self._load_audio_file(path, center_timestamp)
