...
def location_model_train(model, av_model_fix, data_loader, optimizer, criterion_location, criterion_category, epoch, obj_rep, weight):
    model.train()
    av_model_fix.eval()
    accs = 0
    count = 0
...
def main(weight):
    ...
    parser.add_argument('--json_file', type=str,
                        default='./data/MUSIC_label/MUSIC_duet_videos.json')
    ...
    parser.add_argument('--ckpt_file', type=str, default='location_cluster_net_006_0.899_avg_whole.pth', help='pretrained model name')
